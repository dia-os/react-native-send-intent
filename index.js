...
var SendIntentAndroid = {
    ...
    cancelApp(packageName, action, type, data, extras) {
        return RNSendIntentAndroid.cancelApp(packageName, action, type, data, extras || {});
    },
    ...
    openScanner(dataUri) {
        return RNSendIntentAndroid.openScanner(dataUri);
    },
};
