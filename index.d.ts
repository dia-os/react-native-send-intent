declare namespace SendIntentAndroid {
  ...
  const openApp: (packageName: string, action: string, type: string, data: string, extras?: { [index: string]: string }) => Promise<boolean>
  const cancelApp: (packageName: string, action: string, type: string, data: String, extras?: {[index: string]: string }) => Promise<boolean>
  ...
  const openScanner: (dataUri: string) => Promise<boolean>
